                                        ...
                                        <li>
                                            <ul role="list" class="-mx-2 space-y-1">
                                                <li v-for="item in navigation" :key="item.name">
                                                    <span @click="router.push(item.href)"
...
const navigation = [
    ...
    { name: 'Jobs', href: '/recruiter/jobs', icon: CalendarIcon, current: false },
    { name: 'Candidates', href: '/recruiter/candidates', icon: UsersIcon, current: false },
    { name: 'Applications', href: '/recruiter/applications', icon: FolderIcon, current: false },
    { name: 'Interviews', href: '#', icon: DocumentDuplicateIcon, current: false },
    { name: 'Bulk Ops', href: '#', icon: DocumentDuplicateIcon, current: false },
